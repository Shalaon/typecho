...
<div class="comment-author">
        ...
        <?php 
       //判断是不是QQ邮箱，是的话就用QQ头像
        if (preg_match('/^\d{5,11}@qq\.(com)$/', strtolower($comments->mail))) {
            $img    = explode("@", strtolower($comments->mail));
            $qq     = $img[0];
			...
			echo '<img class="avatar" src="https://q1.qlogo.cn/g?b=qq&k='.$k.'&s=100" width="32" height="32">';
        }else{
...
<?php } ?>
<div id="comments" class="post-page mdui-center mdui-typo">
